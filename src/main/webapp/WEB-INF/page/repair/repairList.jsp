...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                {field:'equName', title: '维修设备名称', align:'center'},
                {field:'paetsName', title: '维修设备配件名称', align:'center'},
                {field:'userName', title: '维修设备分配用户', align:'center'},
                {field:'repairMark', title: '维修描述', align:'center'},
                {field:'repairIspass', title: '维修是否完成', align:'center'},
                {field:'repairStartTime', title: '维修开始时间', align:'center'},
                {field:'repairEndTime', title: '维修完成时间', align:'center'},
        ...
        table.on('tool(demo)', function(obj){
            var data = obj.data;
            if(obj.event === 'del'){
                layer.confirm('设备配件：'+data.equName, {icon: 3, title:'是否确定删除?'}, function(index){
                    $.ajax({
                        url:'/repair/del',
                        type:'post',
                        data:{'equId':data.repairId},
                        dataType:"json",
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/repair/repairEdit',
        ...
        $('.btnAdd').on('click',function(){
            layer.open({
                ...
                anim: 0,
                shade: [0.5, 'rgb(0,0,0)'],
                content: '/web/page/repair/repairAdd',
                zIndex: layer.zIndex, //重点1
