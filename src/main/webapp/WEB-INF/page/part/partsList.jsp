...
<script>
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                {field:'paetsName', title: '设备配件名称', align:'center'},
                {field:'equName', title: '所属设备名称', align:'center'},
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/parts/partsEdit',
        ...
        $('.btnAdd').on('click',function(){
            layer.open({
                ...
                anim: 0,
                shade: [0.5, 'rgb(0,0,0)'],
                content: '/web/page/parts/partsAdd',
                zIndex: layer.zIndex, //重点1
