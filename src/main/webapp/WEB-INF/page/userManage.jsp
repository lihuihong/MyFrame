...
<body>
    <form class="layui-form">
        <div class="layui-form-item layui-elem-quote">
            ...
            <button type="button" class="layui-btn layui-btn-normal btnAdd">+ 用户管理</button>
        </div>
    </form>
...
<script>
    layui.use('table', function(){
        ...
        table.on('tool(demo)', function(obj){
            var data = obj.data;
            if(obj.event === 'del'){
                layer.confirm('用户标题：'+data.userUsername, {icon: 3, title:'是否确定删除?'}, function(index){
                    $.ajax({
                        url:'/userInfo/userDelete.json',
                        type:'post',
                        data:{'id':data.id},
                        dataType:"json",
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/userInfo/userEdit.action',
